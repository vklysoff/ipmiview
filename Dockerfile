...
ADD IPMIView_2.22.0_build.241017_bundleJRE_Linux_x64.tar.gz /opt/
RUN mv /opt/IPMIView_2.22.0_build.241017_bundleJRE_Linux_x64 /opt/IPMIView
ADD libs/*.so /opt/IPMIView/
